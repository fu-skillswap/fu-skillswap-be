...
@TestPropertySource(properties = "spring.datasource.url=jdbc:h2:mem:admin_dashboard_testdb;MODE=PostgreSQL;DATABASE_TO_LOWER=TRUE;DB_CLOSE_DELAY=-1;INIT=CREATE DOMAIN IF NOT EXISTS JSONB AS JSON")
@Transactional
