...
class AdminForumControllerSecurityTest {
    ...
    void adminForumReports_adminShouldBeAllowed() throws Exception {
        ...
        when(adminForumModerationService.getReports(any(ReportListQuery.class)))
                .thenReturn(PageResponse.<ReportView>builder().content(List.of()).page(0).size(20).totalElements(0).totalPages(0).last(true).build());
