...
public enum ErrorCode {
    ...
    GOOGLE_CALENDAR_AVAILABILITY_UNAVAILABLE(503, "CAL_4405", "error.calendar.availability_unavailable", "Chưa thể kiểm tra lịch Google Calendar của mentor, vui lòng thử lại sau"),
