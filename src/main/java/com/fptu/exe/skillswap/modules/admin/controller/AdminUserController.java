...
public class AdminUserController {
    ...
    public ApiResponse<SystemUserResponse> banUser(
        ...
        return ApiResponse.success(AdminUserModerationService.changeUserStatus(principal.getPublicId(), userId, true, request.getReason()));
    }
    ...
    public ApiResponse<SystemUserResponse> unbanUser(
        ...
        return ApiResponse.success(AdminUserModerationService.changeUserStatus(principal.getPublicId(), userId, false, request.getReason()));
    }
}
