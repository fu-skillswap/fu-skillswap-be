...
public class ConversationService {
    ...
    @Transactional(readOnly = true)
    public org.springframework.data.domain.Page<com.fptu.exe.skillswap.modules.chat.dto.response.ConversationResponse> getMyConversations(UUID userId, org.springframework.data.domain.Pageable pageable) {
        ...
        return conversationsPage.map(conv -> {
            ...
            return com.fptu.exe.skillswap.modules.chat.dto.response.ConversationResponse.builder()
                    .id(conv.getId())
                    .type(conv.getType())
    ...
    @Transactional(readOnly = true)
    public CursorPageResponse<com.fptu.exe.skillswap.modules.chat.dto.response.ConversationResponse> getMyConversations(UUID userId,
                                                                                                                               String cursor,
                                                                                                                               Integer limit) {
        ...
        List<com.fptu.exe.skillswap.modules.chat.dto.response.ConversationResponse> items = visibleConversations.stream()
        ...
        String nextCursor = hasNext && !visibleConversations.isEmpty()
                ...
                : null;
        return CursorPageResponse.<com.fptu.exe.skillswap.modules.chat.dto.response.ConversationResponse>builder()
                .items(items)
    ...
    @Transactional(readOnly = true)
    public org.springframework.data.domain.Page<com.fptu.exe.skillswap.modules.chat.dto.response.MessageResponse> getMessages(UUID conversationId, UUID userId, org.springframework.data.domain.Pageable pageable, com.fptu.exe.skillswap.modules.chat.repository.MessageRepository messageRepository) {
        ...
        return messageRepository.findByConversationIdOrderByCreatedAtDesc(conversationId, pageable)
                .map(msg -> com.fptu.exe.skillswap.modules.chat.dto.response.MessageResponse.builder()
                        .id(msg.getId())
    ...
    @Transactional(readOnly = true)
    public CursorPageResponse<com.fptu.exe.skillswap.modules.chat.dto.response.MessageResponse> getMessages(UUID conversationId,
                                                                                                                     UUID userId,
                                                                                                                     String cursor,
                                                                                                                     Integer limit) {
        ...
        List<com.fptu.exe.skillswap.modules.chat.domain.Message> messageWindow = messageRepository.findMessageWindow(
                conversationId,
                decodedCursor.sortAt(),
                decodedCursor.entityId(),
                resolvedLimit + 1
        ...
        List<com.fptu.exe.skillswap.modules.chat.domain.Message> visibleMessages = hasNext
                ? messageWindow.subList(0, resolvedLimit)
                : messageWindow;
        List<com.fptu.exe.skillswap.modules.chat.dto.response.MessageResponse> items = visibleMessages.stream()
        ...
        String nextCursor = hasNext && !visibleMessages.isEmpty()
                ...
                : null;
        return CursorPageResponse.<com.fptu.exe.skillswap.modules.chat.dto.response.MessageResponse>builder()
                .items(items)
                .nextCursor(nextCursor)
                .prevCursor(null)
                .hasNext(hasNext)
    ...
    @Transactional
    public com.fptu.exe.skillswap.modules.chat.dto.response.MessageResponse sendMessage(UUID conversationId, UUID userId, com.fptu.exe.skillswap.modules.chat.dto.request.SendMessageRequest request, com.fptu.exe.skillswap.modules.chat.repository.MessageRepository messageRepository, com.fptu.exe.skillswap.modules.identity.repository.UserRepository userRepository) {
        if (!participantRepository.existsByConversationIdAndUserId(conversationId, userId)) {
        ...
        com.fptu.exe.skillswap.modules.chat.domain.Message message = com.fptu.exe.skillswap.modules.chat.domain.Message.builder()
                .conversation(conversation)
                .sender(sender)
                .messageType(com.fptu.exe.skillswap.modules.chat.domain.MessageType.TEXT)
                .content(content)
        ...
        com.fptu.exe.skillswap.modules.chat.dto.event.ChatMessageEvent event = com.fptu.exe.skillswap.modules.chat.dto.event.ChatMessageEvent.builder()
        ...
        java.util.List<ChatMessageRealtimeDelivery> deliveries = participants.stream()
                ...
                .map(p -> {
                    ...
                    com.fptu.exe.skillswap.modules.chat.dto.event.ChatMessageEvent recipientEvent =
                            com.fptu.exe.skillswap.modules.chat.dto.event.ChatMessageEvent.builder()
        ...
        return com.fptu.exe.skillswap.modules.chat.dto.response.MessageResponse.builder()
                .id(message.getId())
                .sequence(message.getSequence())
                .conversationId(conversation.getId())
                .senderId(sender.getId())
    ...
    private void addGroupParticipantIfAbsent(Conversation conversation, User user,
                                             com.fptu.exe.skillswap.modules.chat.domain.ConversationParticipantRole role,
    ...
    @Transactional(readOnly = true)
    public List<com.fptu.exe.skillswap.modules.chat.dto.response.MessageResponse> getMessagesBySequence(UUID conversationId, UUID userId, Long beforeSequence, Long afterSequence, Integer limit) {
        ensureParticipant(conversationId, userId);
    ...
    @Transactional
    public com.fptu.exe.skillswap.modules.chat.dto.response.ChatAttachmentUploadIntentResponse createAttachmentUploadIntent(
            UUID conversationId, UUID userId, com.fptu.exe.skillswap.modules.chat.dto.request.ChatAttachmentUploadIntentRequest request) {
        ensureParticipant(conversationId, userId);
        ...
        var intent = com.fptu.exe.skillswap.modules.chat.domain.ChatUploadIntent.builder()
        ...
        return new com.fptu.exe.skillswap.modules.chat.dto.response.ChatAttachmentUploadIntentResponse(intent.getId(), upload.uploadUrl(), upload.expiresAt(), contentType);
    }

    @Transactional(readOnly = true)
    public com.fptu.exe.skillswap.modules.chat.dto.response.ChatAttachmentDownloadResponse downloadAttachment(UUID attachmentId, UUID userId) {
        ...
        var access = resolveMessagingAccess(conversation, userId);
        if (!access.canDownloadAttachments() || attachment.getState() != com.fptu.exe.skillswap.modules.chat.domain.ChatAttachmentState.ACTIVE
        ...
        return new com.fptu.exe.skillswap.modules.chat.dto.response.ChatAttachmentDownloadResponse(download.downloadUrl(), download.expiresAt());
    }

    @Transactional(readOnly = true)
    public com.fptu.exe.skillswap.modules.chat.dto.response.ConversationResponse getConversationDetail(UUID conversationId, UUID userId) {
        ...
        boolean isParticipant = participants.stream().anyMatch(p -> p.getUser().getId().equals(userId)
                && p.getAccessState() != com.fptu.exe.skillswap.modules.chat.domain.ConversationParticipantAccess.REVOKED);
        if (!isParticipant) {
            throw new com.fptu.exe.skillswap.shared.exception.BaseException(
    ...
    public List<ChatMessageRealtimeDelivery> buildChatMessageDeliveries(UUID conversationId, UUID messageId, UUID senderId) {
        com.fptu.exe.skillswap.modules.chat.domain.Message message = messageRepository.findById(messageId)
    ...
    private com.fptu.exe.skillswap.modules.chat.dto.response.ConversationResponse mapConversationResponse(
            Conversation conv,
            UUID userId,
    ...
    private com.fptu.exe.skillswap.modules.chat.dto.response.MessageResponse toMessageResponse(
            com.fptu.exe.skillswap.modules.chat.domain.Message msg,
            UUID userId) {
    ...
    private com.fptu.exe.skillswap.modules.chat.dto.response.MessageResponse toMessageResponse(
        ...
        return com.fptu.exe.skillswap.modules.chat.dto.response.MessageResponse.builder()
                ...
                .senderName(msg.getSender() != null ? msg.getSender().getFullName() : "Hệ thống")
                .messageType(msg.getMessageType())
                .content(msg.getState() == com.fptu.exe.skillswap.modules.chat.domain.MessageState.DELETED ? null : msg.getContent())
                .state(msg.getState())
                .version(msg.getVersion())
    ...
    @Transactional
    public com.fptu.exe.skillswap.modules.chat.dto.response.MessageResponse deleteMessage(UUID conversationId, UUID messageId, UUID userId, com.fptu.exe.skillswap.modules.chat.dto.request.DeleteMessageRequest request) {
        ...
        message.setState(com.fptu.exe.skillswap.modules.chat.domain.MessageState.DELETED);
        message.setDeletedAt(DateTimeUtil.now()); message.setDeletedByUserId(userId);
        chatAttachmentRepository.findByMessageId(messageId).forEach(a -> { a.setState(com.fptu.exe.skillswap.modules.chat.domain.ChatAttachmentState.REVOKED); a.setRevokedAt(DateTimeUtil.now()); });
        return toMessageResponse(messageRepository.saveAndFlush(message), userId);
    }

    @Transactional
    public com.fptu.exe.skillswap.modules.chat.dto.response.ConversationReadResponse markConversationAsRead(UUID conversationId, UUID userId, long requestedSequence) {
        ...
        return new com.fptu.exe.skillswap.modules.chat.dto.response.ConversationReadResponse(conversationId, participant.getLastReadSequence(), other, unread);
    }

    private void assertEditable(com.fptu.exe.skillswap.modules.chat.domain.Message message, UUID userId, Integer expectedVersion) {
        if (message.getMessageType() != com.fptu.exe.skillswap.modules.chat.domain.MessageType.TEXT || message.getSender() == null || !message.getSender().getId().equals(userId) || message.getState() != com.fptu.exe.skillswap.modules.chat.domain.MessageState.ACTIVE) throw new BaseException(ErrorCode.CHAT_MESSAGE_NOT_EDITABLE);
    ...
    private ErrorCode resolveMessagingAccessError(com.fptu.exe.skillswap.modules.booking.service.BookingChatAccessPolicy.Access access) {
        if (access.readOnlyReason() == com.fptu.exe.skillswap.modules.chat.domain.ChatReadOnlyReason.ADMIN_LOCKED
                || access.readOnlyReason() == com.fptu.exe.skillswap.modules.chat.domain.ChatReadOnlyReason.ACCOUNT_RESTRICTED) {
            return ErrorCode.CHAT_CONVERSATION_LOCKED;
        }
        return ErrorCode.CHAT_CONVERSATION_READ_ONLY;
    }

    private void consumeAttachmentIntents(Conversation conversation, UUID userId, com.fptu.exe.skillswap.modules.chat.domain.Message message, List<UUID> intentIds) {
        ...
        for (UUID intentId : new java.util.LinkedHashSet<>(intentIds)) {
            ...
            if (!intent.getConversation().getId().equals(conversation.getId()) || !intent.getOwnerUserId().equals(userId) || intent.getStatus() != com.fptu.exe.skillswap.modules.chat.domain.ChatUploadIntentStatus.PENDING_UPLOAD || intent.getExpiresAt().isBefore(DateTimeUtil.now())) throw new BaseException(ErrorCode.CHAT_UPLOAD_INTENT_INVALID);
    ...
    private List<com.fptu.exe.skillswap.modules.chat.dto.response.ChatAttachmentResponse> mapAttachments(UUID messageId) {
        if (chatAttachmentRepository == null) return List.of();
        return chatAttachmentRepository.findByMessageId(messageId).stream().map(a -> new com.fptu.exe.skillswap.modules.chat.dto.response.ChatAttachmentResponse(a.getId(), a.getOriginalFilename(), a.getContentType(), a.getSizeBytes(), inlineCapable(a.getContentType()), a.getState() == com.fptu.exe.skillswap.modules.chat.domain.ChatAttachmentState.ACTIVE && a.getExpiresAt().isAfter(DateTimeUtil.now()), a.getExpiresAt(), a.getState())).toList();
    }
    ...
    private void createBookingConfirmedSystemMessage(UUID conversationId, Booking booking) {
        ...
        Conversation lockedConversation = conversationRepository.findByIdForUpdate(conversationId)
                .orElseThrow(() -> new BaseException(ErrorCode.NOT_FOUND, "Không tìm thấy cuộc hội thoại"));
        var message = com.fptu.exe.skillswap.modules.chat.domain.Message.builder()
                .conversation(lockedConversation)
                .messageType(com.fptu.exe.skillswap.modules.chat.domain.MessageType.SYSTEM)
    ...
    private void ensureParticipant(UUID conversationId, UUID userId) {
        ...
        if (participant.isEmpty() || participant.get().getAccessState() == com.fptu.exe.skillswap.modules.chat.domain.ConversationParticipantAccess.REVOKED) {
    ...
    private String encodeNextMessageCursor(com.fptu.exe.skillswap.modules.chat.domain.Message message, String filterHash) {
        return cursorCodec.encode(CursorTokenPayload.builder()
    ...
    private void enqueueRealtimeOutbox(Conversation conversation,
                                       com.fptu.exe.skillswap.modules.chat.domain.Message message,
                                       User sender,
    ...
    private com.fptu.exe.skillswap.modules.booking.service.BookingChatAccessPolicy.Access resolveMessagingAccess(Conversation conversation, UUID userId) {
        ...
        if (bookingChatAccessPolicy == null) {
            ...
            bookingAccess = new com.fptu.exe.skillswap.modules.booking.service.BookingChatAccessPolicy.Access(
                    com.fptu.exe.skillswap.modules.chat.domain.ChatMessagingAccess.OPEN,
