...
public record BookingResponse(
        ...
        @Schema(description = "true khi lần kiểm tra Calendar lúc mentor accept không khả dụng; booking vẫn dùng database làm nguồn sự thật")
        ...
        boolean canCancel,
        @Schema(description = "Legacy capability: true khi participant có thể complete/confirm. FE mới dùng canCompleteByMentor hoặc canConfirmByMentee.")
        boolean canComplete,
        @Schema(description = "true nếu mentee có thể thanh toán booking")
        boolean canPay,
        @Schema(description = "true nếu mentor có thể chấp nhận booking")
        boolean canAccept,
        @Schema(description = "true nếu mentor có thể từ chối booking")
        boolean canReject,
        @Schema(description = "true nếu mentor có thể xác nhận hoàn tất buổi học")
        boolean canCompleteByMentor,
        @Schema(description = "true nếu mentee có thể xác nhận buổi học đã diễn ra")
        boolean canConfirmByMentee,
        @Schema(description = "true nếu participant có thể mở link/địa điểm tham gia")
        boolean canJoin,
        @Schema(description = "true nếu participant có thể báo vấn đề trong cửa sổ review")
        boolean canReportIssue,
        @Schema(description = "true nếu current user là counterparty có thể phản hồi issue")
        boolean canRespondIssue,
        @Schema(description = "Thời điểm CTA tham gia bắt đầu mở", nullable = true)
        OffsetDateTime joinAvailableAt,
        @Schema(description = "Thời điểm CTA tham gia đóng", nullable = true)
        OffsetDateTime joinClosesAt,
