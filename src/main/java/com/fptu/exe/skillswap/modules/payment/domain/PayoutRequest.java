...
public class PayoutRequest {
    ...
    protected void onCreate() {
        ...
        if (requestedAtUtc == null && requestedAt == null) {
            ...
            requestedAt = com.fptu.exe.skillswap.shared.time.BookingTime.fromInstant(requestedAtUtc);
        } else if (requestedAt != null && requestedAtUtc == null) {
            requestedAtUtc = com.fptu.exe.skillswap.shared.time.BookingTime.toInstant(requestedAt);
        }
    ...
    private void syncShadowFields() {
        if (reviewedAtUtc != null) {
            reviewedAt = com.fptu.exe.skillswap.shared.time.BookingTime.fromInstant(reviewedAtUtc);
        } else if (reviewedAt != null) {
            reviewedAtUtc = com.fptu.exe.skillswap.shared.time.BookingTime.toInstant(reviewedAt);
        }

        if (approvedAtUtc != null) {
            approvedAt = com.fptu.exe.skillswap.shared.time.BookingTime.fromInstant(approvedAtUtc);
        } else if (approvedAt != null) {
            approvedAtUtc = com.fptu.exe.skillswap.shared.time.BookingTime.toInstant(approvedAt);
        }
        ...
        if (rejectedAtUtc != null) {
            rejectedAt = com.fptu.exe.skillswap.shared.time.BookingTime.fromInstant(rejectedAtUtc);
        } else if (rejectedAt != null) {
            rejectedAtUtc = com.fptu.exe.skillswap.shared.time.BookingTime.toInstant(rejectedAt);
        }
    }
}
