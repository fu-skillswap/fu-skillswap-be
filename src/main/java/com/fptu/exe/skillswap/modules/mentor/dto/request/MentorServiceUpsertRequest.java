...
public record MentorServiceUpsertRequest(
        ...
        @Schema(example = "72000", nullable = true, description = "Giá dịch vụ tính theo SCoin. Nếu có phí, giới hạn giá lấy từ cấu hình dịch vụ; nếu miễn phí, giá phải bằng 0.")
