...
@Entity
@Table(name = "settlement_accounts", indexes = {
        @Index(name = "idx_settlement_accounts_owner", columnList = "owner_type, owner_id", unique = true),
        @Index(name = "idx_settlement_accounts_code", columnList = "account_code", unique = true)
})
@Getter
@Setter
@Builder
