...
import com.fptu.exe.skillswap.modules.admin.service.AdminQuestionnaireService;
...
public class AdminMentoringQuestionnaireController {
    ...
    public ApiResponse<List<AdminQuestionnaireVersionSummaryResponse>> listVersions() {
        return ApiResponse.success(adminQuestionnaireService.listVersions());
    }
    ...
    public ApiResponse<MentoringQuestionnaireResponse> getVersion(@PathVariable UUID versionId) {
        return ApiResponse.success(adminQuestionnaireService.getVersion(versionId));
    }
    ...
    public ResponseEntity<ApiResponse<MentoringQuestionnaireResponse>> createVersion(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.created(adminQuestionnaireService.createVersion(principal.getPublicId(), request)));
    }
    ...
    public ApiResponse<AdminQuestionnaireActivationResponse> activateVersion(
        ...
        return ApiResponse.success(adminQuestionnaireService.activateVersion(principal.getPublicId(), request));
    }

    @Operation(summary = "Lấy activation hiện tại")
    @GetMapping("/active")
    public ApiResponse<AdminQuestionnaireActivationResponse> getActive() {
        return ApiResponse.success(adminQuestionnaireService.getActiveActivation());
    }
