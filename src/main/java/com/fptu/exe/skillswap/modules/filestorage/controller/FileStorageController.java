...
import com.fptu.exe.skillswap.modules.filestorage.service.CloudflareR2Service;
...
public class FileStorageController {
    ...
    public ApiResponse<PresignedUploadResponse> getUploadUrl(
        ...
        var presigned = cloudflareR2Service.generatePresignedUploadUrl(filename, contentType);
