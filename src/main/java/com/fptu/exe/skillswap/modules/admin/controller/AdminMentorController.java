...
public class AdminMentorController {
    ...
    private final AdminMentorModerationService AdminMentorModerationService;
    ...
    public ApiResponse<PageResponse<AdminMentorListItemResponse>> getMentors(
        ...
        return ApiResponse.success(AdminMentorModerationService.getMentors(request));
    }
    ...
    public ApiResponse<AdminMentorDetailResponse> getMentorDetail(
        ...
        return ApiResponse.success(AdminMentorModerationService.getMentorDetail(mentorUserId));
    }
}
