...
public class OnboardingStatusController {
    ...
    public ApiResponse<OnboardingStatusResponse> getOnboardingStatus(
        ...
        boolean studentProfileCompleted = userQueryPort != null && userQueryPort.hasCompletedStudentProfile(userId);
        boolean mentorProfileCompleted = mentorQueryPort != null && mentorQueryPort.hasCompletedMentorProfile(userId);

        String verificationStatus = mentorQueryPort != null ? mentorQueryPort.getLatestVerificationStatus(userId) : "NOT_STARTED";
