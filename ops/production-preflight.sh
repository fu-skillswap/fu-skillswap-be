...
for name in \
  ...
  BUNNY_STREAM_API_KEY BUNNY_STREAM_LIBRARY_ID BUNNY_STREAM_TOKEN_AUTH_KEY BUNNY_STREAM_WEBHOOK_SECRET; do
...
for name in JWT_SECRET_KEY CURSOR_AES_KEY CURSOR_HMAC_KEY GOOGLE_TOKEN_ENCRYPTION_KEY \
  ...
  PAYOS_WEBHOOK_SECRET SPRING_MAIL_PASSWORD STORAGE_SECRET_KEY BUNNY_STREAM_API_KEY \
  BUNNY_STREAM_TOKEN_AUTH_KEY BUNNY_STREAM_WEBHOOK_SECRET; do
